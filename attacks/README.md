...
| `compat_omnigen2` | `compat_omnigen2.py` → `COMPAT_omnigen2` (repo root) | Degrade → feature extraction → **OmniGen2** instruction-guided editing | `degrade_method`, `scale` |
...
- [OmniGen2](https://github.com/VectorSpaceLab/OmniGen2) — `COMPAT_omnigen2` in `compat_omnigen2.py`
